...
[JSON template](docs/channels/jsontemplate.md) and
...
# JSON template: {"url": "https://api.example.com/v1/incidents", "body_template": "{\"title\": \"{{.MonitorName}}\", \"ref\": \"{{.EventID}}\"}"}
